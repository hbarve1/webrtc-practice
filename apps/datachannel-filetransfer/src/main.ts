...
let receiveChannel;
let fileReader;
const bitrateDiv = document.querySelector('div#bitrate') as HTMLDivElement;
...
const statusMessage = document.querySelector('span#status') as HTMLSpanElement;
const sendFileButton = document.querySelector(
  'button#sendFile'
) as HTMLButtonElement;
