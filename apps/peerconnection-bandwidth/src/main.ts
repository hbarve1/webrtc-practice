...
const bandwidthSelector = document.querySelector(
  'select#bandwidth'
) as HTMLSelectElement;
const synthetic = document.querySelector('input#synthetic') as HTMLInputElement;
...
function syntheticVideoStream(
  { width = 640, height = 480, signal } = { signal: undefined }
) {
