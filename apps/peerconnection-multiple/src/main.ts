...
const video3 = document.querySelector('video#video3') as HTMLVideoElement;
...
function call() {
  ...
  localStream
    .getTracks()
    .forEach((track) => pc1Local.addTrack(track, localStream));
  ...
  localStream
    .getTracks()
    .forEach((track) => pc2Local.addTrack(track, localStream));
