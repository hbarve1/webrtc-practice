...
const politeIframe = document.getElementById('polite') as HTMLIFrameElement;
const impoliteIframe = document.getElementById('impolite') as HTMLIFrameElement;
let counter = 0;
...
export function startLocalVideo(r1, g1, b1, r2, g2, b2) {
  ...
  localVideo1.play();
  const localVideo2 = document.getElementById(
    'localVideo2'
  ) as HTMLVideoElement;
...
async function setupIframe(el, polite, r1, g1, b1, r2, g2, b2) {
  el.srcdoc = `<!DOCTYPE html>
      ...
      <div id="buttons">
        <button
          onclick='(${startLocalVideo.toString()})(${r1},${g1},${b1},${r2},${g2},${b2});'
          id="${polite ? 'politeStart' : 'impoliteStart'}"
      >Start</button>
